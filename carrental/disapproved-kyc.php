...
{
$id=$_GET['dt'];
$result=mysqli_query($conn,"delete from  tbl_kyc  WHERE k_id=$id") or die(mysqli_error($conn));
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Rejected KYC's</h2>
				...
				<?php if(isset($error)){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php 
$status=2;
									$sql = mysqli_query($conn,"SELECT tbl_user.user_name,tbl_user.email_id,tbl_user.mobile_no,tbl_kyc.status,tbl_kyc.Updation_date,tbl_kyc.k_id from tbl_kyc join tbl_user on tbl_user.user_id=tbl_kyc.u_id where tbl_kyc.Status='".$status."'") or die(mysqli_error($conn));
$cnt=1;
...
?>
							...
							echo $nd; ?></td>																				
										<td>
										<a href="manage-kyc.php?kid=<?php echo $row["k_id"];?>"><i class="fa fa-eye"></i></a>&nbsp;
										<a data-toggle="modal" data-target="#deletemodal" onclick='deletedata(<?php echo $row["k_id"]; ?>)'><i class="fa fa-close"></i></a>
