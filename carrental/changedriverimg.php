...
{
	$result=mysqli_query($conn,"update tbl_driver set photo='".$photo."' where d_id=$id") or die(mysqli_error($conn));
...
<head>
	...
	<title>Car Rental Portal | Admin Update Driver image</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Driver photo </h2>

						<div class="row">
							<div class="col-md-10 col-lg-12">
								<div class="panel panel-default">
									<div class="panel-heading" style="background-color:#001662; color:white;">Driver image</div>
...
<?php 
$id=intval($_GET['imgid']);
$sql=mysqli_query($conn,"SELECT photo from tbl_driver where tbl_driver.d_id=$id") or die(mysqli_error($conn));
$cnt=1;
