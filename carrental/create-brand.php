...
include 'includes/session.php';
	...
	{
		$result = mysqli_query($conn,"insert into tbl_brand (brand_name) values ('".$_POST["brand"]."')") or die(mysqli_error($conn));
				...
				<div class="row" >
						...
						<div class="row">
							<div class="col-md-10 col-lg-12">
								<div class="panel panel-default">
									<div class="panel-heading" style="background-color:#001662; color:white;">Create Brand</div>
  	        	  ...
  	        	  <?php if(isset($error)){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" name="brand" id="brand" maxlength="20" autocomplete="off">
	...
	$('#brand').keyup(function(){
		...
		$.ajax({
			...
			success:function(data)
			{
				if(data != '0')
				{
					$('#availability').html('<label class="error">Brand Already Exists</label>');
