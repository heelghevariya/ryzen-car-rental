...
$result =mysqli_query($conn,"UPDATE tbl_pages SET detail='".$pagedetails."' WHERE type='".$pagetype."'")  or die(mysqli_error($conn));
						...
						<div class="row">
							<div class="col-md-10 col-lg-12">
								<div class="panel panel-default">
									<div class="panel-heading" style="background-color:#001662; color:white;">Edit Pages</div>
...
<?php 
$pagetype=$_GET['type'];
$sql =mysqli_query($conn,"SELECT detail from tbl_pages where type='".$pagetype."'") or die(mysqli_error($conn));
$cnt=1;
