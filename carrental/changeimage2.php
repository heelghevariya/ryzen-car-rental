...
{
	$result=mysqli_query($conn,"update tbl_vehicles set vimage2='".$vimage2."' where vehicle_id=$id") or die(mysqli_error($conn));
					...
					<div class="col-md-12">
						...
						<div class="col-md-10 col-lg-12">
								<div class="panel panel-default">
									<div class="panel-heading" style="background-color:#001662; color:white;">Vehicle Image 2 Details</div>
...
<?php 
$id=intval($_GET['imgid']);
$sql=mysqli_query($conn,"SELECT vimage2 from tbl_vehicles where tbl_vehicles.vehicle_id=$id") or die(mysqli_error($conn));
$cnt=1;
