...
public class CarListScreen extends AppCompatActivity {
    ImageView back_btn;
    TextView mTxtStDay, mTxtEtDay, txtnodata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_car_list_screen);
        ...
        llFilterNSort.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CarListScreen.this, FiltersortActivity.class);
    ...
    private void setCarRecycler() {
       ...
       /* Retrofit retrofit = new Retrofit.Builder()
        ...
        if (!Const_reviewModalList.isEmpty()) {
            carAdapter = new CarAdapter(CarListScreen.this, Const_reviewModalList);
            ...
            public void onFailure(Call<List<CarModal>> call, Throwable t) {
                Toast.makeText(CarListScreen.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
            }
        });
*/
  ...
  /*      Retrofit retrofit = new Retrofit.Builder()
        ...
        if (AGAINreviewModalList1.size() == 0) {
            txtnodata.setVisibility(View.VISIBLE);
            mRcProduct.setVisibility(View.GONE);
        } else {
            txtnodata.setVisibility(View.GONE);
            mRcProduct.setVisibility(View.VISIBLE);
        }
        carAdapter = new CarAdapter(CarListScreen.this, AGAINreviewModalList1);
        mRcProduct.setAdapter(carAdapter);
